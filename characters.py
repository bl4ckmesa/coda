...
class Navi(DefaultPlayer):
    ...
    def buildMoves(self):
        ...
        move_list = {
            ...
            'stand'                        : zip([  30,  32 ], 
                                                 [ 900, 100 ]),
            'attack_damage'                : zip([  17,  25,  18,  39,  25 ], 
                                                 [ 100, 100, 300, 100, 300 ]),
            'attack_defended'              : zip([  17,  25,  18,  39,  25,   2 ], 
            ...
            'combo_initiate'               : zip([   11,  17,  24,  31,  38,  45,   4 ],
                                                 [  200, 100, 100, 300, 400, 200, 400 ]),
            ...
            'execute_combo'                : zip([   4,   5,  43,  36,  29,  22,   15,   8,  38,  31 ], 
                                                 [  75, 275, 175,  75,  75,  75,  100, 100, 100, 100 ]),
